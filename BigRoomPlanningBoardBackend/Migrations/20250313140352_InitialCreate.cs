        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InSameSprint = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InSameSprint = table.Column<bool>(type: "INTEGER", nullable: true),
                    ...
                    AddDependencyTicketEvent_DependencyId = table.Column<int>(type: "INTEGER", nullable: true),
                    AddDependencyTicketEvent_InSameSprint = table.Column<bool>(type: "INTEGER", nullable: true),
                    AddDependencyTicketEvent_DependantTicketId = table.Column<int>(type: "INTEGER", nullable: true),
                    AddDependencyTicketEvent_DependencyTicketId = table.Column<int>(type: "INTEGER", nullable: true),
                    AddOrUpdateSquadSprintStatsEvent_SquadId = table.Column<int>(type: "INTEGER", nullable: true),
                    AddOrUpdateSquadSprintStatsEvent_SprintId = table.Column<int>(type: "INTEGER", nullable: true),
                    Capacity = table.Column<double>(type: "REAL", nullable: true),
                    BackgroundNoise = table.Column<double>(type: "REAL", nullable: true),
                    Note = table.Column<string>(type: "TEXT", nullable: true),
                    AddPlannedPeriodEvent_PlannedPeriodId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    AddTicketEvent_TicketId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    AddTicketEvent_Title = table.Column<string>(type: "TEXT", nullable: true),
                    AddTicketEvent_ColumnOrder = table.Column<int>(type: "INTEGER", nullable: true),
                    AddTicketEvent_PredecessorId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    DeleteSessionId = table.Column<string>(type: "TEXT", nullable: true),
                    DeleteTicketEvent_TicketId = table.Column<int>(type: "INTEGER", nullable: true),
                    EditDependencyEvent_DependencyId = table.Column<int>(type: "INTEGER", nullable: true),
                    EditDependencyEvent_InSameSprint = table.Column<bool>(type: "INTEGER", nullable: true),
